...
const Map<String, dynamic> productDict = {
  ...
  'com.vnappmob.vprice.love10': {
    'id': 'com.vnappmob.vprice.love10',
    'title': 'x 10',
    'description': 'Sponsor 10❤️ to this app'
  },
  'com.vnappmob.vprice.love50': {
    'id': 'com.vnappmob.vprice.love50',
    'title': 'x 50',
...
class _IAPScreenState extends State<IAPScreen> {
  ...
  Future<void> initStoreInfo() async {
    ...
    Set<String> _kProductIds = productDict.entries.map((e) => e.key).toSet();
  ...
  Future<void> loadProducts() async {
    Set<String> _kIds = productDict.entries.map((e) => e.key).toSet();
      ...
      productList.add(Column(
        children: [
          ListTile(
            ...
            title: Text(
              productDict[productDetails.id]['title'],
              style: TextStyle(
                color: textColor,
                fontSize: 20,
              ),
            ...
            subtitle: Text(
              productDict[productDetails.id]['description'],
              style: TextStyle(
                color: textColor,
